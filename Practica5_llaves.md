...
(rfc = ‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]’ OR
‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][A-Z]’ OR
‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][A-Z][0-9]’ OR
‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][A-Z][0-9][0-9]’ OR
‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][A-Z][0-Z]’ OR
‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][A-Z][0-9][A-Z]’ OR
‘[A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][A-Z][A-Z][0-9]’ OR
...
ALTER TABLE tipo_unidad ADD CONSTRAINT pk_tipo_unidad_tipo_unidad PRIMARY KEY  (tipo_unidad)
...
--NULL AND CHECK
ALTER TABLE local_nacional ADD CONSTRAINT chk_local_nacional_tipo CHECK (tipo= "Local" OR "Nacional");
